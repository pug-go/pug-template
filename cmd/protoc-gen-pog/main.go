...
func generateFiles(plugin *protogen.Plugin, file *protogen.File) {
	...
	for _, service := range file.Services {
		for _, method := range service.Methods {
			...
			genMethod(methodFile, service, method)
		}
	}
}

func writeHeader(file *protogen.GeneratedFile, protoPath string, pkg protogen.GoPackageName) {
...
func genMethod(
	...
	file.P("// ", methodName, " TODO: implement")
